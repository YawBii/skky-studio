...
export const Route = createFileRoute("/team")({
  head: () => ({ meta: [{ title: "Team — yawB" }, { name: "description", content: "Workspace members and invitations." }] }),
  component: TeamPage,
});
...
function TeamPage() {
  ...
  if (!isReal || !current) {
    return <ProjectScopedEmpty icon={Users} eyebrow="Team" title="Create a workspace first" hint="Team members live inside a workspace." cta={{ label: "Go home", to: "/" }} />;
  }
  return (
    <ProjectScopedEmpty
      icon={Users}
