    ...
    <div className="px-6 md:px-10 py-10 max-w-[1100px] mx-auto">
      <div className="mb-6">
        ...
        <p className="text-muted-foreground mt-1">
          Connected to Vercel · {vercel.repoFullName ?? "no repo metadata"}
        </p>
      </div>
      <div className="rounded-2xl border border-white/5 bg-gradient-card p-6 text-[13px] text-muted-foreground">
        Live deploy log streaming connects in the next pass. Diagnostics are written to the browser
        console under <code className="font-mono text-foreground/80">[yawb] selection</code>.
        <div className="mt-4">
          <Link to="/connectors" className="text-primary text-[12px]">
