...
export const deployRuns: DeployRun[] = [
  {
    ...
    stages: [
      {
        id: "queue", label: "Queued", status: "ok", durationMs: 1_100,
        lines: [
          { ts: "10:42:01.004", level: "info", text: "Webhook received from github.com/skky-group/portal" },
          { ts: "10:42:01.812", level: "info", text: "Build assigned to runner iad1-build-7f3" },
        ],
      },
      {
        id: "clone", label: "Clone", status: "ok", durationMs: 2_400,
        lines: [
      ...
      {
        id: "install", label: "Install", status: "ok", durationMs: 12_400,
        lines: [
      ...
      {
        id: "build", label: "Build", status: "ok", durationMs: 18_900,
        lines: [
      ...
      {
        id: "upload", label: "Upload", status: "ok", durationMs: 4_300,
        lines: [
          { ts: "10:42:36.110", level: "info", text: "Uploading 24 files to Vercel edge (region: iad1)" },
          { ts: "10:42:40.401", level: "success", text: "✓ Upload complete" },
        ],
      },
      {
        id: "verify", label: "Verify", status: "ok", durationMs: 3_200,
        lines: [
          { ts: "10:42:40.510", level: "info", text: "GET https://portal.skky.group → 200 OK (412ms)" },
          { ts: "10:42:43.701", level: "success", text: "✓ Lighthouse: 98 perf · 100 a11y · 100 seo" },
  ...
  },
  {
    ...
    region: "iad1",
    stages: [
      { id: "queue", label: "Queued", status: "ok", durationMs: 800,
        lines: [{ ts: "11:58:03.001", level: "info", text: "Webhook received from github.com/skky-group/portal" }] },
      { id: "clone", label: "Clone", status: "ok", durationMs: 2_100,
        lines: [{ ts: "11:58:05.110", level: "success", text: "✓ Cloned skky-group/portal at b9112e8" }] },
      { id: "install", label: "Install", status: "ok", durationMs: 9_900,
        lines: [{ ts: "11:58:15.001", level: "success", text: "✓ Installed 414 packages in 9.9s" }] },
      {
        id: "build", label: "Build", status: "error", durationMs: 8_900,
        lines: [
          { ts: "11:58:15.402", level: "info", text: "vite build --mode production" },
          { ts: "11:58:21.110", level: "error", text: "src/routes/cloud.tsx(142,18): error TS2322: Type 'string | undefined' is not assignable to type 'string'." },
          { ts: "11:58:21.111", level: "error", text: "  142 |       value={selectedSecret.value}" },
          { ts: "11:58:21.220", level: "error", text: "src/services/cloud.ts(58,7): error TS2554: Expected 1 arguments, but got 0." },
