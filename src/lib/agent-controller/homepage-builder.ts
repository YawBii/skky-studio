...
<body>
  ...
  <main id="top">
    ...
    <section class="trust-strip" aria-label="Trust proof">
      <article>
        ...
        <span>combined legal experience</span>
      </article>
      <article>
        <strong>4.9/5</strong>
    ...
    <section id="practice" class="section practice-areas">
      ...
      <div class="cards-grid services-grid">
        <article class="service-card">
          <h3>Corporate</h3>
          <p>Formation, contracts, acquisitions, founder disputes, and governance.</p>
        </article>
        <article class="service-card">
          <h3>Litigation</h3>
          <p>Commercial disputes, negotiations, filings, and settlement strategy.</p>
        </article>
        <article class="service-card">
          <h3>Family</h3>
          <p>Divorce, custody, asset planning, and sensitive family agreements.</p>
        </article>
        <article class="service-card">
          <h3>Immigration</h3>
          <p>Work visas, family petitions, residency strategy, and compliance.</p>
        </article>
        <article class="service-card">
          <h3>Real Estate</h3>
          <p>Closings, leases, purchase agreements, and property disputes.</p>
        </article>
        <article class="service-card">
          <h3>Employment</h3>
          <p>Executive agreements, workplace disputes, policies, and severance.</p>
        </article>
      </div>
    </section>
    ...
    <section id="process" class="section process-section">
      ...
      <ol class="process-list">
        <li>
          <span>01</span>
          <h3>Consultation</h3>
          <p>Tell us what happened. We identify the right next step.</p>
        </li>
        <li>
          <span>02</span>
          <h3>Review</h3>
          <p>Your attorney reviews documents, facts, deadlines, and options.</p>
        </li>
        <li>
          <span>03</span>
          <h3>Strategy</h3>
          <p>You receive a plain-English plan before any engagement begins.</p>
        </li>
        <li>
          <span>04</span>
          <h3>Resolution</h3>
          <p>We handle negotiation, drafting, filing, and communication.</p>
        </li>
      </ol>
    </section>
    ...
    <section id="team" class="section team-section">
      ...
      <div class="team-grid">
        <article class="team-card">
          ...
          <h3>Margaret Hsu</h3>
          <p>Managing Partner · Corporate</p>
        </article>
        <article class="team-card">
          <div class="avatar">DO</div>
          <h3>David Okafor</h3>
          <p>Partner · Litigation</p>
        </article>
        <article class="team-card">
          <div class="avatar">ER</div>
          <h3>Elena Rossi</h3>
          <p>Partner · Immigration</p>
        </article>
        <article class="team-card">
          <div class="avatar">SP</div>
          <h3>Samuel Park</h3>
          <p>Senior Counsel · Family</p>
        </article>
      </div>
    </section>
    ...
    <section id="pricing" class="section pricing-section">
      <div class="section-heading">
        ...
        <h2>Simple engagement options.</h2>
      </div>
      <div class="pricing-grid">
        <article class="price-card">
          <h3>First consultation</h3>
          <p class="price">$0</p>
          <p>Initial call, issue review, and next-step recommendation.</p>
          <a class="button button-secondary cta" href="#contact">Book free</a>
        </article>
        <article class="price-card featured">
          <h3>Fixed-scope matter</h3>
          <p class="price">$2,400+</p>
          <p>Contracts, filings, negotiations, and focused representation.</p>
          <a class="button button-primary cta" href="#contact">Start now</a>
        </article>
        <article class="price-card">
          <h3>Monthly counsel</h3>
          <p class="price">$4,800+</p>
          <p>Ongoing advice for founders, operators, and families.</p>
          <a class="button button-secondary cta" href="#contact">Talk to us</a>
        </article>
      </div>
    </section>
    ...
    <section class="section testimonial-section">
      <div class="section-heading">
        ...
        <h2>Trusted by people who need clarity fast.</h2>
      </div>
      <div class="testimonial-grid">
        <blockquote>
          <p>“They turned a complicated dispute into a clear, manageable plan.”</p>
          <cite>Founder, software company</cite>
        </blockquote>
        <blockquote>
          <p>“Direct, careful, and extremely responsive from the first call.”</p>
          <cite>Family law client</cite>
        </blockquote>
        <blockquote>
          <p>“The best legal experience we have had as a growing company.”</p>
      ...
      <div class="contact-panel">
        ...
        <form class="contact-form" onsubmit="event.preventDefault();">
          ...
          <label class="full">
            ...
            <textarea rows="4" placeholder="Briefly describe your situation"></textarea>
          </label>
  ...
  --shadow:0 24px 70px rgba(13,36,67,.16);
  --radius:20px;
  --max:1180px;
}
...
h1{font-size:clamp(2.7rem,6vw,5.4rem);line-height:.98;max-width:11ch}
...
.site-navigation{display:flex;gap:1.25rem;align-items:center;flex-wrap:wrap;color:var(--muted);font-size:.95rem}
.site-navigation a:hover{color:var(--navy)}
.button{
  display:inline-flex;
  align-items:center;
...
.button-small{padding:.65rem 1rem;background:var(--navy);color:var(--white)}
.button-primary{background:var(--navy);color:var(--white);box-shadow:0 12px 30px rgba(13,36,67,.2)}
...
.lede{font-size:1.18rem;color:var(--muted);max-width:58ch;margin-top:1.25rem}
...
.card-kicker{color:var(--gold);font-weight:900;text-transform:uppercase;letter-spacing:.18em;font-size:.74rem;margin-bottom:.85rem}
.hero-card h2{font-size:clamp(1.7rem,3vw,2.4rem)}
.hero-card ul{padding-left:1.1rem;margin:1.25rem 0 0;color:var(--muted);display:grid;gap:.55rem}
.trust-strip{
  max-width:var(--max);
  margin:0 auto;
...
.trust-strip strong{display:block;color:var(--gold);font-family:Georgia,serif;font-size:1.75rem}
.trust-strip span{font-size:.88rem;color:rgba(255,255,255,.78)}
.section{padding:clamp(4rem,7vw,7rem) clamp(1rem,3vw,2rem)}
...
.cards-grid,.team-grid,.pricing-grid,.testimonial-grid{
  max-width:var(--max);
  margin:0 auto;
  display:grid;
...
.service-card,.team-card,.price-card,blockquote{
  background:var(--paper);
  border:1px solid var(--line);
  border-radius:var(--radius);
  padding:1.5rem;
}
.service-card p,.team-card p,.price-card p,blockquote cite{color:var(--muted);margin-top:.6rem}
...
.process-list h3{color:var(--white);margin:.55rem 0}
.process-list p{color:rgba(255,255,255,.72)}
.team-section{background:var(--paper-2)}
.team-card{text-align:center;background:var(--white)}
.avatar{
  width:70px;
  height:70px;
  border-radius:50%;
...
.price-card{background:var(--paper);display:grid;gap:1rem}
.price-card.featured{background:var(--navy);color:var(--white)}
...
blockquote{background:var(--white);margin:0}
blockquote p{font-family:Georgia,serif;font-size:1.1rem;color:var(--navy)}
blockquote cite{display:block;font-style:normal}
.contact-section{background:linear-gradient(135deg,var(--navy),var(--navy-2));}
.contact-panel{
  max-width:900px;
  margin:0 auto;
  background:var(--white);
...
.contact-panel > p:not(.eyebrow){color:var(--muted);margin-top:.7rem}
.contact-form{
  margin-top:1.6rem;
  display:grid;
...
.contact-form label{display:grid;gap:.4rem;font-weight:800;color:var(--navy)}
...
.site-footer{padding:1.5rem;text-align:center;color:var(--muted);font-size:.85rem}
@media(max-width:900px){
  .site-header{align-items:flex-start;flex-direction:column}
  .site-navigation{gap:.8rem}
  .hero{grid-template-columns:1fr}
  .trust-strip,.cards-grid,.team-grid,.pricing-grid,.testimonial-grid,.process-list{grid-template-columns:1fr}
