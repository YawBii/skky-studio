...
export interface PlanRoute   { path: string; purpose: string }
export interface PlanModel   { name: string; fields: string }
export interface PlanRisk    { level: "low" | "med" | "high"; text: string }
...
export const readiness: ReadinessItem[] = [
  ...
  { id: "vercel",   label: "Vercel connected",     ok: false, fixHint: "Required to ship to production.", fixAction: "Connect Vercel" },
  { id: "domain",   label: "Custom domain",        ok: false, fixHint: "Optional — your .lovable.app URL still works.", fixAction: "Add domain" },
];
